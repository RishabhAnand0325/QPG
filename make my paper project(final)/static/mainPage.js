...
$('.paper_type').change(function () {
    ...
    if (responseID == "Objective") {
        $('#Objective').removeClass("hidden");
        $('#Objective').addClass("show");
        $('#Subjective').removeClass("show");
        $('#Subjective').addClass("hidden");
        $('#true-false').removeClass("show");
        $('#true-false').addClass("hidden");
        $('#fill-in-blanks').removeClass("show");
        $('#fill-in-blanks').addClass("hidden");
    }

    else if (responseID == "Subjective") {
        $('#Subjective').removeClass("hidden");
        $('#Subjective').addClass("show");
    ...
    else if (responseID == "true-false") {
        $('#true-false').removeClass("hidden");
        $('#true-false').addClass("show");
        $('#Objective').removeClass("show");
        $('#Objective').addClass("hidden");
        $('#Subjective').removeClass("show");
        $('#Subjective').addClass("hidden");
    ...
    else if (responseID == "fill-in-blanks") {
        $('#fill-in-blanks').removeClass("hidden");
        $('#fill-in-blanks').addClass("show");
        $('#Objective').removeClass("show");
        $('#Objective').addClass("hidden");
        $('#Subjective').removeClass("show");
        $('#Subjective').addClass("hidden");
